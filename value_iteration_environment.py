...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        PhotoImage = ImageTk.PhotoImage
        up = PhotoImage(Image.open(os.getcwd() + "/img/up.png").resize((13, 13)))
        right = PhotoImage(Image.open(os.getcwd() + "/img/right.png").resize((13, 13)))
        left = PhotoImage(Image.open(os.getcwd() + "/img/left.png").resize((13, 13)))
        down = PhotoImage(Image.open(os.getcwd() + "/img/down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open(os.getcwd() + "/img/rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open(os.getcwd() + "/img/triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open(os.getcwd() + "/img/circle.png").resize((65, 65)))
